...
$(document).ready(function(){
	...
	var shifton = false;
	var campoActivo="#usernameDocumento";

	$("#alias").click(function(e) {
		campoActivo="#username";
	});

	$("#documento").click(function(e) {
		campoActivo="#usernameDocumento";
	});
	...
	$("#usernameDocumento").click(function(e) {
		campoActivo="#usernameDocumento";
	});
	...
	$("#showkeyboard").click(function(e) {
		...
		topValIE+="px";
		topValMo+="px";
		$('#keyboard').css({left:leftVal, _top:topValIE, top:topValMo}).toggle();
	});
